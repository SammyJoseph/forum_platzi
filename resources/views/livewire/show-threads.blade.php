<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-10 py-12">
    ...
    <div class="w-64">
        <a href="{{ route('threads.create') }}" class="block w-full py-4 mb-6 bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-600 text-white/90 font-bold text-sm text-center rounded-md uppercase">Preguntar</a>
                        ...
                        <div class="w-full">
                            ...
                            <p class="flex items-center justify-between w-full text-xs">
                                ...
                                <span class="flex items-center gap-1 text-slate-700">
                                    <a href="{{ route('thread', $thread) }}" class="hover:text-white flex items-center gap-1">
                                    ...
                                    @can('update', $thread) {{-- verifica si tiene permisos para editar la pregunta (ThreadPolicy) --}}
                                        |
